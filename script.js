...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const skillsData = {
        labels: ['SQL', 'Tableau', 'Excel/VBA', 'Power BI', 'Salesforce', 'Google Sheets'],
        datasets: [{
            label: 'Skill Proficiency',
            data: [95, 90, 85, 88, 80, 85],
            backgroundColor: 'rgba(85, 107, 223, 0.2)',
            borderColor: 'rgba(85, 107, 223, 1)',
            pointBackgroundColor: 'rgba(85, 107, 223, 1)',
            pointBorderColor: '#fff',
            pointHoverBackgroundColor: '#fff',
            pointHoverBorderColor: 'rgba(85, 107, 223, 1)'
        }]
    };
